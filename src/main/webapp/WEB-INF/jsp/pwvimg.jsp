			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu"
						href="${pageContext.request.contextPath}/pwvimg"><i
				...
				<div class="row">
					<div class="col-md-12">
						<div class="alert alert-info">
							This is a free responsive admin under cc3.0 license, so you can
							use it for personal and commercial use. <br /> Enjoy this admin
							and for more please keep looking <a href="http://#/"
								target="_blank">www.cssmoban.com</a>
						</div>
					</div>
